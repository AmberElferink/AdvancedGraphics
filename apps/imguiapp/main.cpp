...
void PrepareScene()
{
	...
	int lightBulb2 = renderer->AddPointLight(make_float3(64, -6, 21), make_float3(8000), true);
	int lightBulb3 = renderer->AddPointLight(make_float3(64, -6, 21), make_float3(8000), true);
